  ...
  return (
    <div class="relative h-screen flex items-center justify-center">
      ...
      <div class="relative z-10 text-center text-white">
        <h1 class="text-4xl md:text-6xl font-bold mb-4">Njordr Exterior Renovations</h1>
        <p class="text-xl md:text-2xl mb-8">Transform Your Home's Exterior in Winnipeg</p>
        <a
          href="#contact"
